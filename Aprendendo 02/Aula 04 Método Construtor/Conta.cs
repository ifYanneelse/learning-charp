...
namespace BankingSystem
{
    ...
    */
    ...
    public class Conta
    {
        ...
        //construtor | sempre o mesmo nome da instancia ex.: Conta conta = new Conta()
        ...
        {
            this.Numero = numero; //this.propriedade da classe = numero que informar
        }
        ...
        public int Numero { get; private set; } //private pra não não deixar fazer o set através do Program | só aparecer quando chamar o construtor
